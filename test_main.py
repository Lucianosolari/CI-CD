import pytest
from main import suma, resta, multiplica, divide, isString, isPar, potencia, isPositivo
...
def test_isPositivo():
    assert isPositivo(5) == True
    assert isPositivo(-3) == False
    assert isPositivo(0) == False
